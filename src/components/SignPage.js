...
export default function SignPage() {
  ...
  const [data, setFormData] = useState({email: "", password: "", name: "", image: ""});
   ...
   setDataLoading({...dataLoading, loading:true, classNameLoading: "input-disabled"});
    ...
    promise.then((response) => {
        ...
        Swal.fire({
            position: 'top-end',
            icon: 'success',
            title: 'Parabéns, o seu cadastro foi realizado com sucesso',
  ...
  return (
    <>
    <Container onSubmit={handleSingUp}>
        ...
        <Form >
            ...
            <input 
                ...
                required 
                value={data.password} 
                onChange={(e) => setFormData({...data, password: e.target.value})}
            />
            <input 
                type="text" 
                disabled={dataLoading.loading} 
            ...
            />
            <button type="button" onClick={previewImage}>Ver Imagem</button>
